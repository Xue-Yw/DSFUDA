...
__all__ = ["teacher_our_FPN"]


@META_ARCH_REGISTRY.register()
class teacher_our_FPN(nn.Module):
    """
    teacher_our_fPN. Any models that contains the following three components:
    ...
    def inference(
        ...
        if do_postprocess:
            ...
            return teacher_our_FPN._postprocess(results, batched_inputs, images.image_sizes)
        else:
            return results
